...
const LeftMenu = ({ shouldUpdateStrapi, version, plugins, setUpdateMenu }) => {
  ...
  useEffect(() => {
    // console.log('SINGLE TYPES: ', filteredSingleTypeLinks);
    // console.log('COLLECTION TYPES: ', filteredCollectionTypeLinks);
    // console.log('Home Links: ', homelinks);
  }, [filteredSingleTypeLinks, filteredCollectionTypeLinks])
